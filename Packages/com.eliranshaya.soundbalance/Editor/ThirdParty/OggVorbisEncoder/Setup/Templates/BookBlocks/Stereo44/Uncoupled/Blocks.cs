...
public class Blocks
{
    public class BlockNeg1 : IStaticBookBlock
    {
        public IStaticCodeBook[][] Books { get; } = {
            ...
            new IStaticCodeBook[] {new CN1.Page7_0(), new CN1.Page7_1(), new CN1.Page7_2()}
        };
    }
    ...
    public class Block1 : IStaticBookBlock
    {
        public IStaticCodeBook[][] Books { get; } = {
            ...
            new IStaticCodeBook[] {new C1.Page7_0(), new C1.Page7_1(), new C1.Page7_2()},
        };
    }
    ...
    public class Block2 : IStaticBookBlock
    {
        public IStaticCodeBook[][] Books { get; } = {
            ...
            new IStaticCodeBook[] {new C2.Page7_0(), new C2.Page7_1(), new C2.Page7_2()}
        };
    }
    ...
    public class Block3 : IStaticBookBlock
    {
        public IStaticCodeBook[][] Books { get; } = {
            ...
            new IStaticCodeBook[] {new C3.Page6_0(), new C3.Page6_1()},
            new IStaticCodeBook[] {new C3.Page7_0(), new C3.Page7_1(), new C3.Page7_2()}
        };
    }
    ...
    public class Block4 : IStaticBookBlock
    {
        public IStaticCodeBook[][] Books { get; } = {
            ...
            new IStaticCodeBook[] {new C4.Page6_0(), new C4.Page6_1()},
            new IStaticCodeBook[] {new C4.Page7_0(), new C4.Page7_1(), new C4.Page7_2()}
        };
    }
    ...
    public class Block6 : IStaticBookBlock
    {
        public IStaticCodeBook[][] Books { get; } = {
            ...
            new IStaticCodeBook[] {null, null, new C6.Page5_0()},
            new IStaticCodeBook[] {null, null, new C6.Page6_0()},
    ...
    public class Block7 : IStaticBookBlock
    {
        public IStaticCodeBook[][] Books { get; } = {
            ...
            new IStaticCodeBook[] {null, null, new C7.Page5_0()},
            new IStaticCodeBook[] {null, null, new C7.Page6_0()},

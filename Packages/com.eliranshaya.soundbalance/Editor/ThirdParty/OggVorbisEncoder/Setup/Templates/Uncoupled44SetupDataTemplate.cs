...
{
class Uncoupled44SetupDataTemplate : ISetupTemplate
{
    public int Mappings => SampleRateMapping.Length - 1;
    public double[] SampleRateMapping { get; } = Psy44.RateMap_Uncoupled;
    ...
    public IMappingTemplate[] Maps { get; } = Residue44.MapRes_Uncoupled;
}
}
